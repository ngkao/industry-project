...
const BetSimulationBox = ({hasShades}) => {
    ...
    return (
        <div className="betsimulationbox">
            <div className={` ${hasShades ? "betsimulationbox__title-ctr--highlighted" : "betsimulationbox__title-ctr"}`}>
            ...
            <div className={`${hasShades ? "betsimulationbox__shades" : ""}`}>
